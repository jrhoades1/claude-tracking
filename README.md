...
**March 2026** | Last updated: 2026-03-03 18:33 UTC
...
|---------|----------|-------|--------|-------|--------|-------|-----------|
| JOB-APPLICATIONS | 63 | 61,432 | 7,630,376 | 1,954,708,102 | claude-opus-4-6, claude-sonnet-4-6 | 57% | $57.33 |
| dark-software-factory | 19 | 141,777 | 2,941,868 | 1,405,692,252 | <synthetic>, claude-opus-4-6, claude-sonnet-4-6 | 41% | $41.15 |
| web | 4 | 960 | 210,705 | 51,718,550 | claude-sonnet-4-6 | 2% | $1.52 |
| EASTER-ISLAND | 0 | -- | -- | -- | -- | -- | -- |
| ald-call-analysis | 0 | -- | -- | -- | -- | -- | -- |
...
| claude-tracking | 0 | -- | -- | -- | -- | -- | -- |
| ALD-CALL-ANALYSIS | 0 | -- | -- | -- | -- | -- | -- |
| **TOTAL** | **86** | **204,169** | **10,782,949** | **3,412,118,904** | <synthetic>, claude-opus-4-6, claude-sonnet-4-6 | **100%** | **$100.00** |
