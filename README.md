...
**April 2026** | Last updated: 2026-04-06 12:22 UTC
...
|---------|----------|-------|--------|-------|--------|-------|-----------|
| JOB-APPLICATIONS | 23 | 62,058 | 313,645 | 123,949,067 | claude-opus-4-6 | 63% | $62.76 |
| jimmys-plan | 7 | 364 | 51,220 | 7,964,259 | claude-opus-4-6 | 4% | $4.05 |
| dark-software-factory | 6 | 4,450 | 56,524 | 8,298,316 | claude-opus-4-6 | 4% | $4.22 |
| web | 3 | 22,027 | 142,538 | 57,215,485 | claude-opus-4-6 | 29% | $28.97 |
| vent-thread | 0 | -- | -- | -- | -- | -- | -- |
| Downloads | 0 | -- | -- | -- | -- | -- | -- |
| Claude Setup | 0 | -- | -- | -- | -- | -- | -- |
| VENT-THREAD | 0 | -- | -- | -- | -- | -- | -- |
...
| NCAA | 0 | -- | -- | -- | -- | -- | -- |
| **TOTAL** | **39** | **88,899** | **563,927** | **197,427,127** | claude-opus-4-6 | **100%** | **$100.00** |
